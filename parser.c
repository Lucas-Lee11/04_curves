...
void parse_file ( char * filename,
	...
	while ( fgets(line, sizeof(line), f) != NULL ) {
		...
		if ( strncmp(line, "line", strlen(line)) == 0 ) {
			...
			add_circle(edges, cx, cy, cz, r, STEP_SIZE);
		}//end circle
			...
			add_curve(edges, x0, y0, x1, y1, x2, y2, x3, y3, STEP_SIZE, BEZIER);
		}//end bezier
			...
			add_curve(edges, x0, y0, x1, y1, x2, y2, x3, y3, STEP_SIZE, HERMITE);
		}//end hermite
